...
void DemoActivity::initLights() {
    ...
    light.setVertexData(RenderShapeAdapter<Color3DShader>(tetrahedronShape));
    ...
    light1.setVertexData(RenderShapeAdapter<Color3DShader>(cubeShape));
...
void DemoActivity::buildGrass() {
    grass.setVertexData(RenderShapeAdapter<IncorporateColorTex3DShader>(rectShape));
...
void DemoActivity::buildTransparentWindow() {
    transparentWindow.setVertexData(RenderShapeAdapter<ColorTex3DShader>(rectShape));
...
void DemoActivity::buildWinMask() {
    winMask.setVertexData(RenderShapeAdapter<ColorTex2DShader>(rectShape));
...
void DemoActivity::buildCuboids() {
    ...
    for (int index = 0; index < 10; ++index) {
        ...
        cuboid.setVertexData(RenderShapeAdapter<ColorTexMulilight3DShader>(cubeShape));
    }
    ...
    cuboid1.setVertexData(RenderShapeAdapter<ColorTexMulilight3DShader>(tetrahedronShape));
}

void DemoActivity::buildRectangle3D() {
    rectangle.setVertexData(RenderShapeAdapter<ColorTex3DShader>(rectShape));
    ...
    rectangle1.setVertexData(RenderShapeAdapter<ColorTex3DShader>(rectShape));
...
void DemoActivity::buildMirror() {
    ...
    mirror.setVertexData(RenderShapeAdapter<ColorTex2DShader>(rectShape));
...
void DemoActivity::buildCircle() {
    ...
    circle1.setVertexData(RenderShapeAdapter<ColorTex3DShader>(circleShape));
...
void DemoActivity::buildRichPoints() {
    richPoints.setVertexData(RenderShapeAdapter<ColorGeometryPointShader>(rectShape));
}
